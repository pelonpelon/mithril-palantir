...
var fadesIn = function (element, isInitialized, context) {
  if (!isInitialized) {
    ...
    new Velocity(element, { opacity: 1 });
  }
};
var fadesOut = function (callback) {
  return function (e) {
    ...
    new Velocity(e.target, { opacity: 0 }, {
      complete: function () {
...
var fadesOutPage = function (element, isInitialized, context) {
  if (!isInitialized) {
    element.onclick = function (e) {
      e.preventDefault();
      new Velocity(element.parentNode, { opacity: 0 }, {
        complete: function () {
          m.route(element.getAttribute('href'));
          new Velocity(element.parentNode, { opacity: 1 }, {});  // +++ fade in 'container' on route change
        }
      });
    };
  }
...
animation.view = function (ctrl) {
  return m('.velocity', [
    ...
    m('ul', [animation.people.map(function (person) {
        return m('li', {
          key: person.id,
